...
#         return random.randint(0, self.n-1)
    ...
    def header(self):
        if self.verbose:
            print("{0: >10} {1: >10} {2: >15} {3: >15}".format('SELF.XX', 'ACTIVE_NDS', 'SELF.LB', 'SELF.UB'))

    def stats(self):
        if self.verbose:
            print("{0: >10} {1: >10} {2: >15} {3: >15}".format((str(self.xx)), len(self.active), self.lb, self.ub))
